...
public class Flat implements Comparable <Flat>, Serializable {
    ...
    public Flat(Long id, String name, Coordinates coordinates, LocalDateTime creationDate, Long area, Integer numberOfRooms, Integer height, Boolean newness, Transport transport, House house) {
        this.id = id;
        this.name = name;

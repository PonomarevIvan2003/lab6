            ...
            try {
                switch (processCode) {
                    case OBJECT:
                        ...
                        return new Request(userCommand[0], userCommand[1], flatToInsert);
                    case UPDATE_OBJECT:
                        FlatLite flatToUpdate = generateFlatToUpdate();
                        return new Request(userCommand[0], userCommand[1], flatToUpdate);
                    case SCRIPT:
                    ...
                    case PARAMETER_TRANSPORT:
                        ...
                        return new Request(userCommand[0], userCommand[1], transport);
                    case PARAMETER_NEWNESS:
                        Boolean newness = generateNewness();
                        return new Request(userCommand[0], userCommand[1], newness);
                }
